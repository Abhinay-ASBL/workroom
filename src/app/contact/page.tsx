    ...
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden" style={{ background: 'rgba(82, 77, 246, 0.1)' }}>
        ...
        <div className="relative z-10 px-4 sm:px-6 md:px-12 lg:px-[80px] xl:px-[175px] pt-12 lg:pt-[74px] pb-10 lg:pb-[60px]">
          <h1 className="text-[32px] sm:text-[40px] lg:text-[48px] font-semibold text-black leading-[1.1] mb-3" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>Contact Us</h1>
          <p className="text-[16px] lg:text-[20px] font-normal text-black/60" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>Reach the team</p>
        </div>
      </section>
      <section className="px-4 sm:px-6 md:px-12 lg:px-[80px] xl:px-[175px] py-12 lg:py-[80px]">
        <div className="max-w-[800px]">
          <div className="space-y-6" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>
            <div>
              <h3 className="text-[18px] lg:text-[20px] font-medium text-black mb-2">Email</h3>
              <p className="text-[16px] lg:text-[17px] text-black/80 leading-[1.7]">
                <a href="mailto:workroom@asbl.com" className="text-[#524DF6] hover:opacity-75 transition-opacity">workroom@asbl.com</a>
              </p>
            </div>
            <div>
              <h3 className="text-[18px] lg:text-[20px] font-medium text-black mb-2">Office</h3>
              <p className="text-[16px] lg:text-[17px] text-black/80 leading-[1.7]">
                ASBL Headquarters, Hyderabad, India
              </p>
            </div>
            <div>
              <h3 className="text-[18px] lg:text-[20px] font-medium text-black mb-2">Urgent Matters</h3>
              <p className="text-[16px] lg:text-[17px] text-black/80 leading-[1.7]">
                For urgent matters, reach out on the internal Slack workspace.
              </p>
            </div>
          </div>
        </div>
