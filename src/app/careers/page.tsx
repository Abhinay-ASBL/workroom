    ...
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden" style={{ background: 'rgba(82, 77, 246, 0.1)' }}>
        ...
        <div className="relative z-10 px-4 sm:px-6 md:px-12 lg:px-[80px] xl:px-[175px] pt-12 lg:pt-[74px] pb-10 lg:pb-[60px]">
          <h1 className="text-[32px] sm:text-[40px] lg:text-[48px] font-semibold text-black leading-[1.1] mb-3" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>Careers</h1>
          <p className="text-[16px] lg:text-[20px] font-normal text-black/60" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>Join the ASBL team</p>
        </div>
      </section>
        ...
        <div className="max-w-[800px]">
          <div className="space-y-6" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>
            <p className="text-[16px] lg:text-[17px] text-black/80 leading-[1.7]">
              At ASBL, we believe in building teams that are as thoughtfully crafted as the spaces we create. We value innovation, collaboration, and a deep commitment to quality in everything we do.
            </p>
            <p className="text-[16px] lg:text-[17px] text-black/80 leading-[1.7]">
              We&apos;re always looking for curious minds. Reach out at{' '}
              <a href="mailto:careers@asbl.com" className="text-[#524DF6] hover:opacity-75 transition-opacity">careers@asbl.com</a>
            </p>
          </div>
        </div>
      </section>
