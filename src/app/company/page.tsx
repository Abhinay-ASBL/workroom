    ...
    <div className="min-h-screen bg-white">
      <section className="relative overflow-hidden" style={{ background: 'rgba(82, 77, 246, 0.1)' }}>
        ...
        <div className="relative z-10 px-4 sm:px-6 md:px-12 lg:px-[80px] xl:px-[175px] pt-12 lg:pt-[74px] pb-10 lg:pb-[60px]">
          <h1 className="text-[32px] sm:text-[40px] lg:text-[48px] font-semibold text-black leading-[1.1] mb-3" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>Company</h1>
          <p className="text-[16px] lg:text-[20px] font-normal text-black/60" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>About ASBL</p>
        </div>
      </section>
        ...
        <div className="max-w-[800px]">
          <div className="space-y-6" style={{ fontFamily: "'Roboto', sans-serif", fontVariationSettings: "'wdth' 100" }}>
            <p className="text-[16px] lg:text-[17px] text-black/80 leading-[1.7]">
              ASBL is a real estate developer founded with a mission to build quality homes that stand the test of time. With a focus on thoughtful design and meticulous construction, ASBL has established itself as a trusted name in residential development.
            </p>
            <p className="text-[16px] lg:text-[17px] text-black/80 leading-[1.7]">
              The Workroom is ASBL&apos;s internal platform for knowledge sharing. It brings together research, case studies, and project documentation from across the organization, enabling teams to learn from each other and make better-informed decisions.
            </p>
          </div>
        </div>
      </section>
